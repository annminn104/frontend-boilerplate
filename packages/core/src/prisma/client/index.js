...
const config = {
  generator: {
    ...
    output: {
      value: '/home/minh/Matthew Gearment/frontend-boilerplate/packages/core/src/prisma/client',
      fromEnvVar: null,
    },
    config: {
      engineType: 'library',
  ...
  relativeEnvPaths: {
    rootEnvPath: null,
    schemaEnvPath: '../../../../../apps/landing/.env',
  },
  relativePath: '../../../../../apps/landing/prisma',
  clientVersion: '6.5.0',
  ...
  inlineSchema:
    'generator client {\n  provider = "prisma-client-js"\n  output   = "../../../packages/core/src/prisma/client"\n}\n\ndatasource db {\n  provider = "postgresql"\n  url      = env("DATABASE_URL")\n}\n\n// Add your models here\n\nmodel User {\n  id        String    @id @default(cuid())\n  clerkId   String    @unique\n  email     String    @unique\n  name      String?\n  posts     Post[]\n  comments  Comment[]\n  likes     Like[]\n  createdAt DateTime  @default(now())\n  updatedAt DateTime  @updatedAt\n}\n\nmodel Post {\n  id        String    @id @default(cuid())\n  title     String\n  content   String\n  published Boolean   @default(false)\n  author    User      @relation(fields: [authorId], references: [id])\n  authorId  String\n  likes     Like[]\n  comments  Comment[]\n  createdAt DateTime  @default(now())\n  updatedAt DateTime  @updatedAt\n}\n\nmodel PortfolioSection {\n  id        String   @id @default(cuid())\n  type      String   @unique\n  title     String\n  content   Json     @db.JsonB\n  order     Int\n  createdAt DateTime @default(now())\n  updatedAt DateTime @updatedAt\n}\n\nmodel Like {\n  id        String   @id @default(cuid())\n  post      Post     @relation(fields: [postId], references: [id], onDelete: Cascade)\n  postId    String\n  user      User     @relation(fields: [userId], references: [id])\n  userId    String\n  comment   Comment? @relation(fields: [commentId], references: [id], onDelete: Cascade)\n  commentId String?\n  createdAt DateTime @default(now())\n\n  @@unique([postId, userId])\n  @@unique([commentId, userId])\n}\n\nmodel Comment {\n  id        String   @id @default(cuid())\n  content   String\n  post      Post     @relation(fields: [postId], references: [id], onDelete: Cascade)\n  postId    String\n  author    User     @relation(fields: [authorId], references: [id])\n  authorId  String\n  likes     Like[]\n  createdAt DateTime @default(now())\n  updatedAt DateTime @updatedAt\n}\n',
  inlineSchemaHash: '27d94b4059a61d84884ed9b1d8061ead6951cadb4886e68a190e7ab834f27494',
  copyEngine: true,
}
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = ['../../packages/core/src/prisma/client', '../packages/core/src/prisma/client']
...
path.join(process.cwd(), '../../packages/core/src/prisma/client/libquery_engine-debian-openssl-3.0.x.so.node')
// file annotations for bundling tools to include these files
path.join(__dirname, 'schema.prisma')
path.join(process.cwd(), '../../packages/core/src/prisma/client/schema.prisma')
