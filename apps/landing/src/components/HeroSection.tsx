...
export function HeroSection() {
  ...
  const handleCTAClick = (ctaType: string) => {
    capture('hero_cta_clicked', { cta_type: ctaType })
  }
      ...
      <div className="mx-auto max-w-7xl">
        <div className="relative z-10 bg-white pb-8 sm:pb-16 md:pb-20 lg:w-full lg:max-w-2xl lg:pb-28 xl:pb-32">
          ...
          <div className="relative px-4 pt-6 sm:px-6 lg:px-8">
            {/* Navigation is now in Header component */}
          </div>

          <main className="mx-auto mt-10 max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              <h1 className="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-6xl">
                <span className="block xl:inline">Giải pháp hiện đại</span>{' '}
                <span className="block text-indigo-600 xl:inline">cho doanh nghiệp của bạn</span>
              </h1>
              <p className="mt-3 text-base text-gray-500 sm:mx-auto sm:mt-5 sm:max-w-xl sm:text-lg md:mt-5 md:text-xl lg:mx-0">
                Chúng tôi cung cấp các công cụ và dịch vụ tốt nhất để giúp doanh nghiệp của bạn phát
                triển trong thời đại số. Tăng hiệu suất, tối ưu hóa quy trình và đạt được mục tiêu
                kinh doanh của bạn.
              </p>
